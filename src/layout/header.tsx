          ...
          <div className="flex flex-1 items-center justify-between">
            ...
            <div className="hidden sm:block">
              <div className="flex space-x-4">
                ...
                <MenuLink active={pathname == '/'} title="Anasayfa" href='/' />
                <MenuLink title="Editör Seçkisi" href='/editor-seckisi' />
                <MenuLink active={pathname.startsWith('/hikaye')} title="Hikayeler" href='/hikayeler' />
                <MenuLink title="Katılımcı Dernekler" href='' />
                <MenuLink title="Editörler" href='' />
                <MenuLink title="Proje Hakkında" href='' />
                <MenuLink title="İletişim" href='' />
              </div>
            </div>
          </div>
        </div>
